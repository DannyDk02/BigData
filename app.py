...
def f1(event, context):
    ...
    s3.upload_file(download_path,'scbucket',f'news/raw/periodico=eltiempo/year={anio}/month={mestexto}/day={dia}/Eltiempo.csv')
    ...
    s3.upload_file(download_path2,'scbucket',f'news/raw/periodico=publimetro/year={anio}/month={mestexto}/day={dia}/publimetro.csv')